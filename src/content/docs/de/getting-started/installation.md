...
[Fadogen herunterladen](https://github.com/fadogen/app/releases/latest/download/Fadogen.dmg), öffnen Sie die `.dmg` und ziehen Sie Fadogen in den Programme-Ordner.
